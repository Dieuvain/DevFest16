...
/**
 * Created by Michelo on 23/10/2016.
 */
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_id=DevFest16Application.prefs.getString(configs.PREFS_USERIDentity,null);
        if(user_id!=null){
                ...
                if(!userStr.isEmpty() && !pwdStr.isEmpty()){
                    ...
                    fireAuth.signInWithEmailAndPassword(userStr,pwdStr).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            ...
                            DevFest16Application.prefs.edit().putString(configs.PREFS_USERIDentity,user.getEmail()).commit();
    ...
    public void register(View v){
        ...
        startActivityForResult(new Intent(getApplicationContext(),RegisterUserActivity.class),REQUEST_REGISTER);
